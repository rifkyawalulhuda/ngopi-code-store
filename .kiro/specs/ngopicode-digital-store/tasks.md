...
- [ ] 2. Implement Tripay Payment Plugin
  ...
  - [~] 2.6 Write property test for webhook signature round-trip
  ...
  - [~] 2.7 Implement webhook controller and processing logic
  ...
  - [~] 2.8 Write property test for webhook idempotency
  ...
  - [~] 2.9 Write property test for non-PAID webhook isolation
...
- [~] 3. Checkpoint - Tripay plugin tests pass
...
- [ ] 4. Implement Digital Fulfillment Plugin
  ...
  - [~] 4.6 Write property test for download record creation correctness
  ...
  - [~] 4.7 Implement secure download link generation
  ...
  - [~] 4.8 Write property test for download access control
  ...
  - [~] 4.9 Write property test for download counter monotonicity
...
- [ ] 6. Implement Order State Machine and Payment Integrity
  ...
  - [~] 6.4 Write property test for PAID webhook triggers full fulfillment
...
- [ ] 7. Implement Email Plugin
  - [~] 7.1 Create email plugin with Resend integration
  ...
  - [~] 7.3 Create email template for order confirmation
...
- [~] 8. Checkpoint - All backend plugins tests pass
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 9. Implement Nuxt 3 Storefront - Product Catalog
  ...
  - [~] 9.2 Implement product catalog page with SSR
  ...
  - [~] 9.3 Implement category filter and search functionality
  ...
  - [~] 9.4 Write property test for category filter correctness
  ...
  - [~] 9.5 Write property test for pagination correctness
...
- [ ] 10. Implement Nuxt 3 Storefront - Checkout Flow
  - [~] 10.1 Implement shopping cart functionality
  ...
  - [~] 10.2 Implement checkout page with guest checkout support
  ...
  - [~] 10.3 Implement payment initiation and redirect
  ...
  - [~] 10.4 Implement payment return handling
...
- [ ] 11. Implement Nuxt 3 Storefront - Download Page
  - [~] 11.1 Implement download page with order lookup
  ...
  - [~] 11.2 Implement download action and error handling
...
- [ ] 13. Integration wiring and security hardening
  - [~] 13.1 Wire Tripay plugin with Digital Fulfillment plugin for end-to-end flow
  ...
  - [~] 13.2 Configure security controls
  ...
  - [~] 13.3 Create Dokploy deployment configuration
  ...
  - [~] 13.4 Write integration tests for end-to-end payment flow
...
- [~] 14. Final checkpoint - All tests pass and system is deployment-ready
  - Ensure all tests pass, ask the user if questions arise.

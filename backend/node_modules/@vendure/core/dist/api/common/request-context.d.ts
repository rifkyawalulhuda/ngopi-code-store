 ...
 */
export declare function internal_setRequestContext(req: RequestWithStores, ctx: RequestContext, executionContext?: ExecutionContext): void;
/**
 * @description
 * Gets the {@link RequestContext} from the `req` object. See {@link internal_setRequestContext}
 * for more details on this mechanism.
 */
export declare function internal_getRequestContext(req: RequestWithStores, executionContext?: ExecutionContext): RequestContext;
/**
 * @description

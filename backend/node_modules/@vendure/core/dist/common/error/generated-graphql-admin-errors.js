...
class DuplicateEntityError extends ErrorResult {
    constructor(input) {
        super();
        this.__typename = 'DuplicateEntityError';
        this.errorCode = 'DUPLICATE_ENTITY_ERROR';
        this.message = 'DUPLICATE_ENTITY_ERROR';
...
class OrderInterceptorError extends ErrorResult {
    constructor(input) {
        super();
        this.__typename = 'OrderInterceptorError';
        this.errorCode = 'ORDER_INTERCEPTOR_ERROR';
        this.message = 'ORDER_INTERCEPTOR_ERROR';
...
class ProductOptionGroupInUseError extends ErrorResult {
    constructor(input) {
        super();
        this.__typename = 'ProductOptionGroupInUseError';
        this.errorCode = 'PRODUCT_OPTION_GROUP_IN_USE_ERROR';
        this.message = 'PRODUCT_OPTION_GROUP_IN_USE_ERROR';
        this.optionGroupCode = input.optionGroupCode;
        this.productCount = input.productCount;
        this.variantCount = input.variantCount;
    }
}
exports.ProductOptionGroupInUseError = ProductOptionGroupInUseError;
...
class RefundAmountError extends ErrorResult {
    constructor(input) {
        super();
        this.__typename = 'RefundAmountError';
        this.errorCode = 'REFUND_AMOUNT_ERROR';
        this.message = 'REFUND_AMOUNT_ERROR';
...
exports.adminErrorOperationTypeResolvers = {
    ...
    RemoveProductOptionGroupFromChannelResult: {
        __resolveType(value) {
            return isGraphQLError(value) ? value.__typename : 'ProductOptionGroup';
        },
    },

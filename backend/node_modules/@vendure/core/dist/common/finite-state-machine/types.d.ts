 ...
 */
export type OnTransitionStartFn<T extends string, Data> = (fromState: T, toState: T, data: Data) => boolean | string | void | Promise<boolean | string | void> | Observable<boolean | string | void>;
/**
 * @description
 ...
 * @docsPage StateMachineConfig
 */
export type OnTransitionErrorFn<T extends string> = (fromState: T, toState: T, message?: string) => void | Promise<void> | Observable<void>;
/**
 * @description
 ...
 * @docsPage StateMachineConfig
 */
export type OnTransitionEndFn<T extends string, Data> = (fromState: T, toState: T, data: Data) => void | Promise<void> | Observable<void>;
/**
 * @description

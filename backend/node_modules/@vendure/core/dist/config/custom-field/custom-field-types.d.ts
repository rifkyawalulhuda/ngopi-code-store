import { CustomField, BooleanCustomFieldConfig as GraphQLBooleanCustomFieldConfig, BooleanStructFieldConfig as GraphQLBooleanStructFieldConfig, DateTimeCustomFieldConfig as GraphQLDateTimeCustomFieldConfig, DateTimeStructFieldConfig as GraphQLDateTimeStructFieldConfig, FloatCustomFieldConfig as GraphQLFloatCustomFieldConfig, FloatStructFieldConfig as GraphQLFloatStructFieldConfig, IntCustomFieldConfig as GraphQLIntCustomFieldConfig, IntStructFieldConfig as GraphQLIntStructFieldConfig, LocaleStringCustomFieldConfig as GraphQLLocaleStringCustomFieldConfig, LocaleTextCustomFieldConfig as GraphQLLocaleTextCustomFieldConfig, RelationCustomFieldConfig as GraphQLRelationCustomFieldConfig, StringCustomFieldConfig as GraphQLStringCustomFieldConfig, StringStructFieldConfig as GraphQLStringStructFieldConfig, StructCustomFieldConfig as GraphQLStructCustomFieldConfig, StructField as GraphQLStructField, TextCustomFieldConfig as GraphQLTextCustomFieldConfig, TextStructFieldConfig as GraphQLTextStructFieldConfig, LocalizedString, Permission } from '@vendure/common/lib/generated-types';
import { CustomFieldsObject, CustomFieldType, DefaultFormComponentId, StructFieldType, Type, UiComponentConfig } from '@vendure/common/lib/shared-types';
 ...
 */
export type TypedCustomSingleFieldConfig<T extends CustomFieldType, C extends CustomField> = BaseTypedCustomFieldConfig<T, C> & {
    list?: false;
...
export type LocaleTextCustomFieldConfig = TypedCustomFieldConfig<'localeText', GraphQLLocaleTextCustomFieldConfig>;

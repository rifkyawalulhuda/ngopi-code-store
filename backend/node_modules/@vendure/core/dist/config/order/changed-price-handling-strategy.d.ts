...
export interface ChangedPriceHandlingStrategy extends InjectableStrategy {
     ...
     */
    handlePriceChange(ctx: RequestContext, current: PriceCalculationResult, orderLine: OrderLine, order: Order): PriceCalculationResult | Promise<PriceCalculationResult>;
}

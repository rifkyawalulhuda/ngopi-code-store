...
import { CustomRefundStates, RefundState, RefundTransitionData } from '../../service/helpers/refund-state-machine/refund-state';
/**
 * @description
 ...
 */
export interface CustomRefundProcess<State extends keyof CustomRefundStates | string> extends RefundProcess<State> {
}

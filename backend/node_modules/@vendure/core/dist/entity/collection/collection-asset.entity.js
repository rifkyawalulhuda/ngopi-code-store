...
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.ManyToOne)(type => collection_entity_1.Collection, collection => collection.assets, { onDelete: 'CASCADE' }),
    __metadata("design:type", collection_entity_1.Collection)
], CollectionAsset.prototype, "collection", void 0);
exports.CollectionAsset = CollectionAsset = __decorate([
    (0, typeorm_1.Entity)(),

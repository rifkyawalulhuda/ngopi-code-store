...
const facet_entity_1 = require("./facet.entity");
let FacetTranslation = class FacetTranslation extends base_entity_1.VendureEntity {
    constructor(input) {
        super(input);
    }
};
...
exports.FacetTranslation = FacetTranslation = __decorate([
    (0, typeorm_1.Entity)(),

...
let ProductAsset = class ProductAsset extends orderable_asset_entity_1.OrderableAsset {
    constructor(input) {
        super(input);
    }
};
...
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.ManyToOne)(type => product_entity_1.Product, product => product.assets, { onDelete: 'CASCADE' }),
    __metadata("design:type", product_entity_1.Product)
], ProductAsset.prototype, "product", void 0);
exports.ProductAsset = ProductAsset = __decorate([
    (0, typeorm_1.Entity)(),

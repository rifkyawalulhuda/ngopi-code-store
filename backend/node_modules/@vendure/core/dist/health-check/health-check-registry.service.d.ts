 ...
 */
export declare class HealthCheckRegistryService {
    /** @internal */
    get healthIndicatorFunctions(): HealthIndicatorFunction[];
    private _healthIndicatorFunctions;
    /**
     * @description
     ...
     */
    registerIndicatorFunction(fn: HealthIndicatorFunction | HealthIndicatorFunction[]): void;
}

...
exports.migrateProductOptionGroupData = migrateProductOptionGroupData;
/**
 * @description
 ...
 */
async function migrateProductOptionGroupData(queryRunner) {
    const hasProductId = await queryRunner.hasColumn('product_option_group', 'productId');
    if (!hasProductId) {
        console.log('The productId column on product_option_group does not exist. ' +
    ...
    await queryRunner.query(`INSERT INTO ${esc('product_option_groups_product_option_group')} (${esc('productId')}, ${esc('productOptionGroupId')})
    ...
    await queryRunner.query(`INSERT INTO ${esc('product_option_group_channels_channel')} (${esc('productOptionGroupId')}, ${esc('channelId')})
    ...
    await queryRunner.query(`INSERT INTO ${esc('product_option_channels_channel')} (${esc('productOptionId')}, ${esc('channelId')})
...
//# sourceMappingURL=v3_6_shared_option_groups.js.map
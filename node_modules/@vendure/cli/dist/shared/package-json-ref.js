...
const monorepo_utils_1 = require("../utilities/monorepo-utils");
class PackageJson {
    constructor(project) {
    ...
    getRootPackageJsonContent() {
        ...
        if (!packageJsonPath || !fs_extra_1.default.existsSync(packageJsonPath)) {
            (0, prompts_1.note)(`Could not find root package.json in the current directory. Please run this command from the root of an npm project.`);
            return false;
        }
        return fs_extra_1.default.readJsonSync(packageJsonPath);
    }
    ...
    addScriptToVendurePackageJson(scriptName, script) {
        const packageJson = this.getPackageJsonContent();
        if (packageJson) {
    ...
    addScriptToRootPackageJson(scriptName, script) {
    ...
    locatePackageJsonWithVendureDependency() {
        ...
        const rootDir = this.getPackageRootDir().getPath();
        const packageJsonPath = (0, monorepo_utils_1.findPackageJsonWithDependency)(rootDir, '@vendure/core');
        if (packageJsonPath) {

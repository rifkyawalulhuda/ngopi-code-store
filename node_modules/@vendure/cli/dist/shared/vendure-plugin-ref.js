...
class VendurePluginRef {
    ...
    addMetadataProperty(prop, value) {
        var _a;
        const pluginOptions = this.getMetadataOptions();
        const existingProperty = pluginOptions.getProperty(prop);
        if (existingProperty) {
            const existingValue = ts_morph_1.Node.isPropertyAssignment(existingProperty)
                ? this.normalizeStringValue((_a = existingProperty.getInitializer()) === null || _a === void 0 ? void 0 : _a.getText())
